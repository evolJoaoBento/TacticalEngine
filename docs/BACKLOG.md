...
**Pinned to commit `1f39fae`.** At that commit: `npx tsc --noEmit` clean, **1766 unit tests across
89 files**, **101 Playwright tests** (about 4.2 minutes). If those numbers come back lower, something
