...
out.append('- **a rider on the standard attack** — "targets who mark HP must also mark a Stress",')
out.append('  "the Ogre\'s attacks deal direct damage", "reduce the damage by 1d10": a passive that')
out.append('  rewrites the swing the block already prints, rather than adding a feature to play.')
...
out.append('damage type is a `defenses` line, and the blocks that print one have it.\n')
