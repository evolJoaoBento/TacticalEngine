...
out.append('- **a rider the swing cannot see** — "reduce the damage by 1d10", "deal 1d6+5 instead')
out.append('  of their standard damage when another Wolf is in Melee range": a passive that swaps')
out.append('  the damage or answers being attacked, rather than following the swing that landed.')
