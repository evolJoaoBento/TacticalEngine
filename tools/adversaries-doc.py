...
out.append('Two things are *not* reasons. Facing is not: "in front of the Burrower" is read as the')
out.append('whole band, as Spit Acid has been from the start. Nor is a passive that changes how')
out.append('damage lands — resistance, flat reduction, a standard attack that deals direct damage,')
out.append('a rider on every hit. Those are one shape, and the next pass over these blocks is theirs.\n')
