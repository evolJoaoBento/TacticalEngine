...
out.append('- **a token on the stat block**, teleporting,')
...
out.append('  they used armor", "equal to the HP they marked", "up to three targets". A wound is')
out.append('  answered by trigger - `tookDamage`, `tookHitPoints`, `tookSevere`, each with whoever')
out.append('  dealt it bound as the target - but how much of it landed is not a number a script can')
out.append('  read, so "when it marks 2 or more HP" stays here.')
