...
out.append('Acid has been from the start. Nor is a swarm: "spotlight all Giant Rats within Close')
out.append('range of them" is a `joinedBy` on the attack the feature makes, and the rest of the')
out.append('kind walk in and swing with it. Nor is resistance — a passive that halves or ignores a')
